    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecField", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSpecField", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "SpecField",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecField_ProductId",
                table: "ProductSpecField",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecField_SpecFieldId",
                table: "ProductSpecField",
                column: "SpecFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecField_CategoryId",
                table: "SpecField",
                column: "CategoryId");
